...
function sendEmail() {
    if ($('#grid').data('kendoGrid').selectedKeyNames().length > 0) {
        ...
        var subject = encodeURIComponent('欢迎Star： and Site~'),
            body = encodeURIComponent('<p><a href="http://localhost:65021/">http://localhost:65021/</a></p><p> and Site base on Kendo UI for jQuery and Bootstrap 4.</p>');
